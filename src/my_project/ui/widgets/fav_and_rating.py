...
class HeartButton(QPushButton):
    ...
    def __init__(self, already_fav: bool, size: tuple[int, int]):
        ...
        self.empty_icon = QIcon(":/icons/heart_outline.svg")
        self.full_icon = QIcon(":/icons/heart_filled.svg")
...
class StarRating(QWidget):
    ...
    def __init__(self, rating: float, size: tuple[int, int]):
        ...
        self.full_star = QPixmap(":/icons/star_filled.svg")
        self.half_star = QPixmap(":/icons/star_half.svg")
        self.empty_star = QPixmap(":/icons/star_outline.svg")
